 ...
 */
public class PeopleFragment extends Fragment  implements ContractPeople.PeopleView {

   private RecyclerView recyclerView;

   private PeopleAdapter peopleAdapter;

   private ContractPeople.PeoplePresenter peoplePresenter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setPresenter();
        peoplePresenter.loadCharacters();;
    }
    ...
    public void showCharacters(List<Starship> characters) {
        ...
        peopleAdapter = new PeopleAdapter((MainActivity) getActivity(), characters);
