...
public class ButtonFragment extends Fragment {
    ...
    //Dichiaro i Buttons people-planets-starships

    private Button mBtnPeople;
    private Button mBtnPlanets;
    private Button mBtnStarships;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mBtnPeople = (Button) view.findViewById(R.id.btnPeople);
        ...
        mBtnStarships = (Button) view.findViewById(R.id.btnStarships);
        mBtnStarships.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.onBtnStarshipsClicked();
            }
        });
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onBtnPeopleClicked();

        void onBtnPlanetsClicked();

        void onBtnStarshipsClicked();
    }
}
